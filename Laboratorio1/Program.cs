...
var connectionString = builder.Configuration.GetConnectionString("miconexionsql") ?? throw new InvalidOperationException("Connection string 'ConexionDesar' not found.");
